...
int main(){
	...
	sorting(job, sortmap, number_of_jobs);

	/*for(i=0; i<number_of_jobs;i++)
	{
	printf("\n %c %d %d", job[i].name, job[i].arrival_time, job[i].service_time);
	}*/
	...
	inverse_sorting(Result, sortmap, total_length);
